          ...
          <div class="card rounded-0">
            <div class="card-body p-0 rounded-0">
              <div class="card-header">
                <h5 class="card-title m-0">Edit Pricing Structure</h5>
              </div>
              <div class="p-3">
...
export default {
  ...
  created() {
    ...
    //   this.brandArray = data.data.result;
    // });
  ...
  methods: {
    getOne() {
      if (this.$route.params._id) {
        service.getOne(`PricingStructure/${this.$route.params._id}`, data => {
          this.form = data.data;
        });
      }
    },
    onSubmit(form) {
      service.updateData("PricingStructure/updateData", form, data => {
        if (data.data) {

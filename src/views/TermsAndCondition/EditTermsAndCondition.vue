          ...
          <div class="card rounded-0">
            <div class="card-body p-0 rounded-0">
              <div class="card-header">
                <h5 class="card-title m-0">Edit TermsAndCondition</h5>
              </div>
              <div class="p-3">
...
export default {
      ...
      breadCrum: [
        {
          ...
          href: "/view-TermsAndCondition"
        },
        {
          text: "Edit TermsAndCondition"
        }
      ],
      serviceArray: [],
      brandArray: [],
  ...
  created() {
    ...
    service.getOne("TermsAndCondition/" + this.id, data => {
      this.form = data.data;
    });
  },
  methods: {
    onSubmit(form) {
      service.updateData("TermsAndCondition/updateData", form, data => {
        if (data.data) {
          this.$router.push("/view-TermsAndCondition");
        }
      });
    },
    onCancel() {

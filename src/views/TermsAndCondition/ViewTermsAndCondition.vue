            ...
            <div class="p-0 rounded-0">
                  ...
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="ml-5">
                      <button
                        ...
                        onclick="window.location.href='/create-terms-condition'"
                      >Create TermsAndCondition</button>
                    </div>
                  </div>
                </div>
                <h5 class="card-title m-0">TermsAndCondition</h5>
              </div>
              <table class="mb-0 table table-hover table-striped">
                ...
                <tbody class="p-0">
                  ...
                  <tr class="table-body-contents" v-if="!allTermsAndCondition.length">
                  ...
                  <tr
                    ...
                    v-for="(warranty,index) in allTermsAndCondition"
                    v-bind:key="warranty.key"
                  >
                    ...
                    <td class="pl-4">
                      <router-link
                        ...
                        v-b-tooltip.hover
                        title="Edit"
                        :to="{ name: 'Edit TermsAndCondtion', params: { _id: warranty._id } }"
                        append
                      >
...
export default {
  ...
  created() {
    this.viewTermsAndCondition(this.currentPage);
  },

  methods: {
    deleteAndRefresh(obj) {
      service.deleteAll("TermsAndCondition/deleteTerms", obj, data => {
        this.viewTermsAndCondition(this.currentPage);
      });
    },
    viewTermsAndCondition(page) {
      this.currentPage = page;
      const formData = {};
      formData.page = page;
      formData.name = this.searchText;
      service.getallTermsAndConditions(formData, data => {
        if (data.status === 200) {
          this.allTermsAndCondition = data.data.result;
    ...
    goToPage(page) {
      ...
      this.viewTermsAndCondition(page);
    }
  }
};
</script>

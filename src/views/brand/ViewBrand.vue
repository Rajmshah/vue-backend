          ...
          <div class="card rounded-0">
            <div class="p-0 rounded-0">
              ...
              <table class="mb-0 table table-hover table-striped">
                ...
                <tbody class="p-0">
                  <tr class="table-body-contents" v-if="!allBrand.length">
                  ...
                  <tr
                    ...
                    v-bind:key="brand.key"
                    :class="brand.bodyColor"
                  >
                    ...
                    <td class="pl-4">
                      <router-link
                        ...
                        v-b-tooltip.hover
                        title="Edit"
                        :to="{ name: 'Edit Brand', params: { _id: brand._id } }"
                        append
                      >
...
export default {
  ...
  created() {
    this.viewBrand(this.currentPage);
  },

  methods: {
    deleteAndRefresh(obj) {
      service.deleteAll("Brand/deleteBrand", obj, data => {
        this.viewBrand(this.currentPage);
      });
    },
    viewBrand(page) {
      ...
      service.getAllBrandList(formData, data => {
        if (data.status === 200) {
          this.allBrand = data.data.result;

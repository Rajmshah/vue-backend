          ...
          <div class="card rounded-0">
            <div class="p-0 rounded-0">
              ...
              <table class="mb-0 table table-hover table-striped">
                ...
                <tbody class="p-0">
                  <!-- <div class="text-center font-size-lg" v-if="!alllocation.length">No data found.</div> -->
                  <tr class="table-body-contents" v-if="!alllocation.length">
                  ...
                  >
                    ...
                    <td class="pl-4">
                      <router-link
                        ...
                        v-b-tooltip.hover
                        title="Edit"
                        :to="{ name: 'Edit Location', params: { _id: location._id } }"
                        append
                      >
...
export default {
  ...
  created() {
    this.viewLocation(this.currentPage);
  },

  methods: {
    deleteAndRefresh(obj) {
      service.deleteAll("Location/deleteLocation", obj, data => {
        this.viewLocation(this.currentPage);
      });
    },
    viewLocation(page) {
      ...
      service.getAllLocation(formData, data => {
        if (data.status === 200) {
          this.alllocation = data.data.result;

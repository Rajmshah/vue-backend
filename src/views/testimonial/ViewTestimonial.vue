            ...
            <div class="p-0 rounded-0">
                  ...
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="ml-5">
                      <button
                        ...
                        onclick="window.location.href='/create-testimonial'"
                      >Create Testimonial</button>
                    </div>
                  </div>
                </div>
                <h5 class="card-title m-0">Testimonial</h5>
              </div>
              <table class="mb-0 table table-hover table-striped">
                ...
                <tbody class="p-0">
                  ...
                  <tr class="table-body-contents" v-if="!allTestimonial.length">
                  ...
                  <tr
                    ...
                    v-for="(Testimonial,index) in allTestimonial"
                    v-bind:key="Testimonial.key"
                    :class="Testimonial.bodyColor"
                  >
                    ...
                    <td class="pl-4">
                      <router-link
                        ...
                        v-b-tooltip.hover
                        title="Edit"
                        :to="{ name: 'Edit Testimonial', params: { id: Testimonial._id } }"
                        append
                      >
                      ...
                      <button
                        ...
                        v-b-modal.modal-1
                        @click="deleteData(Testimonial._id)"
                      >
...
export default {
  ...
  created() {
    this.viewTestimonial(this.currentPage);
  },

  methods: {
    deleteAndRefresh(obj) {
      service.deleteAll("Testimonial/deleteTestimonial", obj, data => {
        this.viewTestimonial(this.currentPage);
      });
    },
    viewTestimonial(page) {
      this.currentPage = page;
      const formData = {};
      formData.page = page;
      formData.name = this.searchText;
      service.getAllTestimonial(formData, data => {
        if (data.status === 200) {
          this.allTestimonial = data.data.result;

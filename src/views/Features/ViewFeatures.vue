            ...
            <div class="p-0 rounded-0">
                  ...
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="ml-5">
                      <button
                        ...
                        onclick="window.location.href='/create-features'"
              ...
              <table class="mb-0 table table-hover table-striped">
                ...
                <tbody class="p-0">
                  ...
                  <tr class="table-body-contents" v-if="!servicePlanArray.length">
                  ...
                  <tr
                    ...
                    v-for="(service,index) in servicePlanArray"
                  ...
                  >
                    ...
                    <td class="pl-4">
                      <router-link
                        ...
                        v-b-tooltip.hover
                        title="Edit"
                        :to="{ name: 'Edit Features', params: { _id: service._id } }"
                        append
                      >
...
export default {
  ...
  created() {
    this.viewFeatures(this.currentPage);
  },

  methods: {
    deleteAndRefresh(obj) {
      service.deleteAll("Features/deleteFeatures", obj, data => {
        this.viewFeatures(this.currentPage);
      });
    },
    viewFeatures(page) {
      ...
      service.searchFeatures(formData, data => {
          console.log("getting result",data)
        if (data.status === 200) {
          this.servicePlanArray = data.data.result;

                  ...
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="ml-5">
                      <button
                        ...
                        onclick="window.location.href='/create-serviceplan'"
                      >Create Service Plan</button>
                    </div>
                  </div>
                </div>
                <h5 class="card-title m-0">Service Plan</h5>
              </div>
                  ...
                  >
                    ...
                    <td class="pl-4">
                      <router-link
                        ...
                        v-b-tooltip.hover
                        title="Edit"
                        :to="{ name: 'Edit ServicePlan', params: { _id: service._id } }"
                        append
                      >
...
export default {
  ...
  methods: {
    deleteAndRefresh(obj) {
      service.deleteAll("ServicePlan/deleteServicePlan", obj, data => {
        this.viewService(this.currentPage);
      });
    },
    viewService(page) {
      ...
      service.searchServicePlan(formData, data => {

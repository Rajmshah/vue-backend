          ...
          <div class="card rounded-0">
            <div class="card-body p-0 rounded-0">
              <div class="card-header">
                <h5 class="card-title m-0">Edit ServiceInfo</h5>
              </div>
              <div class="p-3">
...
export default {
  ...
  data() {
    return {
      ...
      breadCrum: [
        {
          text: "serviceInfo",
          href: "/view-serviceinfo"
        },
        {
          text: "Edit serviceInfo"
        }
      ],
      serviceArray: [],
      brandArray: [],
  ...
  created() {
    ...
    service.getOne("ServiceInfo/" + this.id, data => {
  ...
  methods: {
    onSubmit(form) {
      service.updateData("ServiceInfo/updateData", form, data => {
        if (data.data) {
          this.$router.push("/view-serviceinfo");
        }
      });
    },
    onCancel() {

            ...
            <div class="p-0 rounded-0">
                  ...
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="ml-5">
                      <button
                        ...
                        onclick="window.location.href='/create-car'"
                      >Create Car</button>
                    </div>
                  </div>
                </div>
                <h5 class="card-title m-0">Cars</h5>
              </div>
              <table class="mb-0 table table-hover table-striped">
                ...
                <tbody class="p-0">
                  ...
                  <tr class="table-body-contents" v-if="!allCar.length">
                  ...
                  >
                    ...
                    <td class="pl-4">
                      <router-link
                        ...
                        v-b-tooltip.hover
                        title="Edit"
                        :to="{ name: 'Edit Car', params:{ _id: car._id }}"
                        append
                      >
...
export default {
  ...
  created() {
    this.viewCar(this.currentPage);
  },

  methods: {
    deleteAndRefresh(obj) {
      service.deleteAll("Car/deleteCar", obj, data => {
        this.viewCar(this.currentPage);
      });
    },
    viewCar(page) {
      ...
      service.getAllCar(formData, data => {
        if (data.data) {
          this.allCar = data.data.result;

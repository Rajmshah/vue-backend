            ...
            <div class="p-0 rounded-0">
                  ...
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="ml-5">
                      <button
                        ...
                        onclick="window.location.href='/create-warranty'"
                      >Create Warranty</button>
                    </div>
                  </div>
                </div>
                <h5 class="card-title m-0">Warranty</h5>
              </div>
              <table class="mb-0 table table-hover table-striped">
                ...
                <tbody class="p-0">
                  ...
                  <tr class="table-body-contents" v-if="!allWarranty.length">
                  ...
                  <tr
                    ...
                    v-for="(warranty,index) in allWarranty"
                  ...
                  >
                    ...
                    <td class="pl-4">
                      <router-link
                        ...
                        v-b-tooltip.hover
                        title="Edit"
                        :to="{ name: 'Edit Warranty', params: { _id: warranty._id } }"
                        append
                      >
...
export default {
  ...
  created() {
    this.viewWarranty(this.currentPage);
  },

  methods: {
    deleteAndRefresh(obj) {
      service.deleteAll("Warranty/deletewarranty", obj, data => {
        this.viewWarranty(this.currentPage);
      });
    },
    viewWarranty(page) {
      ...
      service.getallWarranty(formData, data => {
        console.log("In Here", data);
        if (data.status === 200) {
          this.allWarranty = data.data.result;

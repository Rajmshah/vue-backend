          ...
          <div class="card rounded-0">
            <div class="p-0 rounded-0">
              <div class="card-header">
                ...
                <h5 class="card-title m-0">Blog</h5>
              </div>
              <table class="mb-0 table table-hover table-striped">
                ...
                <tbody class="p-0">
                  <tr class="table-body-contents" v-if="!allBlog.length">
...
export default {
  ...
  created() {
    this.viewBlog(this.currentPage);
  },

  methods: {
    deleteAndRefresh(obj) {
      service.deleteAll("Blog/deleteBlog", obj, data => {
        this.viewBlog(this.currentPage);
      });
    },
    viewBlog(page) {
      ...
      service.getAllBlog(formData, data => {
        if (data.status === 200) {
          this.allBlog = data.data.result;
